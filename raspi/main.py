...
TACTICS = {
    ...
    5: [['lo', 'w1h', 'w2h', 'dd200', 'ta-27', 'la', 'dd350', 'ta23', 'dd1015', 'ta90', 'dd250', 'dd-40', 'ta90', 'dd200', 'dd-600', 'lo', 'dl500', 'dd120', 'ta90', 'dd-200', 'mo', 'dl500', 'ma', 'la', 'dd1250', 'w1r', 'dd-620', 'w1h', 'lo', 'dd-670', 'mo', 'dl500', 'la', 'ma', 'dd120', 'ta-90', 'wt88', 'dd1800']],
    6: [['lo', 'w1h', 'w2h', 'dd200', 'la', 'ta-27', 'dd320', 'ta27', 'dd1025', 'ta90', 'dd270', 'dd-40', 'ta90', 'dd200', 'dd-600', 'lo', 'mo', 'dl500', 'ma', 'dd120', 'ta90', 'dd-230', 'dl500', 'la', 'dd1250', 'w2r', 'dd-600', 'w2h', 'lo', 'dd-670', 'dl500', 'dd120', 'la', 'ta-90', 'wt88', 'dd1800']],
...
class Robot:
    ...
    async def _flow_ready(self):
        try:
            ...
            high_count = 0
            while high_count < 5:
                if GPIO.input(PIN_PULLCORD) == GPIO.HIGH:
                    high_count += 1
                else:
                    high_count = 0
            ...
            self.log(f"FEHLER in _flow_ready: {e}")
            self.state = State.IDLE
            raise
